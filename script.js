...
function initContactsPage() {
    ...
    if (feedbackForm) {
        ...
        const errorElements = {
            name: feedbackForm.querySelector('#name-error'),
            email: feedbackForm.querySelector('#email-error'),
            message: feedbackForm.querySelector('#message-error'),
            agreement: feedbackForm.querySelector('#agreement-error')
        };
        ...
        function validateForm() {
            ...
            if (!nameInput.value.trim() || nameInput.value.trim().length < 2) {
                errorElements.name.textContent = 'Имя должно содержать минимум 2 символа';
                isValid = false;
            } else {
            ...
            if (!emailInput.value.trim() || !emailRegex.test(emailInput.value.trim())) {
                errorElements.email.textContent = 'Введите корректный email';
                isValid = false;
            } else {
            ...
            if (!messageInput.value.trim() || messageInput.value.trim().length < 10) {
                errorElements.message.textContent = 'Сообщение должно содержать минимум 10 символов';
                isValid = false;
            } else {
            ...
            if (!agreementCheckbox.checked) {
                errorElements.agreement.textContent = 'Необходимо согласие на обработку данных';
                isValid = false;
            } else {
                errorElements.agreement.textContent = '';
            }
        ...
        [nameInput, emailInput, messageInput, agreementCheckbox].forEach(input => {
    ...
    // Social links to open in new window
